...
the annotation output requires said annotation files
It outputs eQTL summary and all pairs files, upset plots, and overlaps with a variety of annotations
...
--------------------------------------------------------
--------------------------------------------------------
#how to make scoreboard files (supplementary table 1)

#an example config file is included in this repo: NaiveB_egenes_overlaps_Jan2025_config.txt
