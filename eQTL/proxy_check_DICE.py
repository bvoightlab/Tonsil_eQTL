...
DICE = ["/project/voight_datasets_01/eQTL/DICE/B_CELL_NAIVE.txt.gz", "/project/voight_datasets_01/eQTL/DICE/TFH.txt.gz", "/project/voight_datasets_01/eQTL/DICE/CD4_NAIVE.txt.gz"]
